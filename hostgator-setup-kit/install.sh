...
v_locale() {
  ...
  echo "Escolha 1 (Português), 2 (Español) ou 3 (English) — ou Enter para English"
  return 1
}
...
FIELDS=(
  ...
  "APP_LOCALE|System language — 1) Português  2) Español  3) English (Enter = English)|3|v_locale||"
...
begin
  ...
  if v_org is null then
    ...
    update public.organizations
     ...
     where id = v_org and coalesce(locale, 'pt-BR') in ('pt-BR', 'en');
  end if;
